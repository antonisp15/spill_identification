...
$graph:
  - class: Workflow
    ...
    doc: Oil Spill Detection and Analysis Pipeline 1-2-3-4-5
    ...
    outputs:
      pipeline_output:
        type: Directory
        outputSource: step_snappy_extraction/results
    ...
    steps:
      ...
      step_snappy_extraction:
        in:
          use_case_directory: step_object_detection/results
          sentinel_list: step_data_search/sentinel_list  
          csv_file: step_object_detection/csv_output_path
          verbose: verbose
          debug: debug
        run: "#snappyextraction_tool"
        out:
          - results
  ...
  - class: CommandLineTool
    id: snappyextraction_tool
    label: Snappy Extraction Tool
    requirements:
      - class: InitialWorkDirRequirement
        listing:
          - entryname: $(inputs.use_case_directory.basename)
